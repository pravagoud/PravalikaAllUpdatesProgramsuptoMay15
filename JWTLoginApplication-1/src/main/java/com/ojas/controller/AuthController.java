...
import com.ojas.service.UserDetailsImpl;
...
public class AuthController {
	...
	@PostMapping("/signin")
	public ResponseEntity<?> authenticateUser(@Validated @RequestBody LockRequest loginRequest) {
