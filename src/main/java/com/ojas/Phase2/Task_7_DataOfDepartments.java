...
public class Task_7_DataOfDepartments {
	...
	public static void main(String[] args) {
		...
		if (result == JFileChooser.APPROVE_OPTION) {
			...
			String outputFileName = "Uptodepartments.txt";
	...
	public static String[][] generateEmailsAndPhones(String[] names) {
		String[][] emailsAndPhones = new String[names.length][7];
	...
	public static void saveDataToFile(String[] names, String[][] emailsAndPhones, String fileName) throws IOException {
		...
		writer.write("Name,Email,Country,Phone,Email2,Dob,age,departments" + System.lineSeparator());
		...
		for (int i = 0; i < names.length; i++) {
			writer.write(names[i] + "," + emailsAndPhones[i][0] + "," + emailsAndPhones[i][2] + ","
					...
					+ emailsAndPhones[i][5] + "," + emailsAndPhones[i][6] + System.lineSeparator());
		}
